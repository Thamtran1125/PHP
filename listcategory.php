					...
					<table id="employee_data" class="table table-hover table table-striped table-bordered"  >
						<thead>
							...
							<tr class="style1">
								...
								<td width="50" scope="row"><label>Mã Danh Mục</label></td>
								<td width="50" scope="row"><label>Tên Danh Mục</label></td>
								<td width="50" scope="row"><label>Thao Tác</label></td>
						...
						if ($result == true) 
						{
							...
							while ($kq = mysqli_fetch_array($result)) 
							{
								...
								<tr>
									...
									<td scope="row"><?php echo $kq["Category_Name"]; ?></td>

									<td><a href="insertcategory.php?page=Add">Thêm
