				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
						<div class="menu2">
							...
							<ul class="contact2 ">
								<li>
									<a href="#" title="Shop Giỏ Quà Việt"><img src="Image/visa.png"></a>
								</li>
								<li>
									<a href="#" title="Shop Giỏ Quà Việt"><img src="Image/t5.png"></a>
								</li>
								<li>
									<a href="#" title="Shop Giỏ Quà Việt"><img src="Image/t3.png"></a>
								</li>
								<li>
									<a href="#" title="Shop Giỏ Quà Việt"><img src="Image/t4.png"></a>
								</li>
