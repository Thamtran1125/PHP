...
echo'<tr>
    ...
    <tr style="border-bottom: 2px solid #000;">
      ...
      <td style="border-right: 1px solid #000;">Giá '.number_format($producttotalprice).'</td>
      <td><p style="float:left;margin:0px 0px 0px 20px;font-size:18px;text-decoration:none">Giá '.number_format($producttotalprice*$each_item['quantity']).' VND</p>
	  	<form action="cart.php" method="post">
...
<p style="font-size:20px;text-align:center; color:#fff; line-height:2em">Cart Total: <strong>Giá '.number_format($cartTotal).' VND</strong></p></div>
