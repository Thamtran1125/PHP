<?php
$sql = "SELECT * FROM Product WHERE Discription = 'New' AND Category_Id = '2' ";
	...
	<div class="col-md-3 col-sm-6 text-center">
		<div class="thumbnail">
			...
			<div class="price">
			 ...
			 <a href="Shopping/view.php?Product=<?=$row["Id"]?>"> 
			<button type="button" class="btn btn-info btn-md">Chi tiết</button>

			<a href="#" class="btn btn-info btn-md butndv" value="Buy Now">
